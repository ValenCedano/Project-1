const productos = [
   {
      ...
      'stock_por_color': {'plata': 50, 'dorado': 20}
   },
   {
      'id' : 2,
      'nombre' : 'Aurora Ring',
      ...
      'stock_por_color': {'plata': 20, 'oro': 32},
   },
   
   {
      ...
      'descripcion' : 'brazalete tejido en hilo de oro',
      'stock_por_color': {'plata': 120, 'oro': 32},
   },
   
   {
      ...
      'stock_por_color': {'rosa': 120, 'plata': 41, 'dorado': 32},
   },
   
   {
      ...
      'stock_por_color': {'plateado-dorado': 120},
   },
   
    {
       ...
       'stock_por_color': {'azul': 55, 'aguamarina': 66},
    },
   
    {
       ...
       'stock_por_color': {'rosa': 22, 'plateado': 65, 'azul': 55, 'aguamarina': 66},
    },
   ...
   
    {
       ...
       'stock_por_color': {'rosa': 22, 'morado': 53, 'azul': 55},
    },
   
    {
       ...
       'stock_por_color': {'naranja': 54, 'amarillo': 53, 'dorado': 55},
    },

    {
      ...
      'descripcion' : 'anillo con ojas de oro',
      'stock_por_color': {'oro': 22, 'plata': 53},
   },

   {
      ...
      'stock_por_color': {'plata': 22, 'oro': 53},
   },

   {
      ...
      'stock_por_color': {'plata': 22, 'oro': 66},
   },
